...
class ConditionalAdditiveAutoregressiveBijection(ConditionalAutoregressiveBijection):
...
class ConditionalAffineAutoregressiveBijection(ConditionalAutoregressiveBijection):
